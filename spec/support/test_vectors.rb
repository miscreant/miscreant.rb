...
class Miscreant::Internals::AES::BlockCipher::Example
  ...
  DEFAULT_EXAMPLES = File.expand_path("../../vectors/aes.tjson", __dir__)
...
class Miscreant::Internals::AES::CTR::Example
  ...
  # Default file to load examples from
  DEFAULT_EXAMPLES = File.expand_path("../../vectors/aes_ctr.tjson", __dir__)
...
class Miscreant::AES::CMAC::Example
  ...
  # Default file to load examples from
  DEFAULT_EXAMPLES = File.expand_path("../../vectors/aes_cmac.tjson", __dir__)
...
class Miscreant::AES::PMAC::Example
  ...
  # Default file to load examples from
  DEFAULT_EXAMPLES = File.expand_path("../../vectors/aes_pmac.tjson", __dir__)
...
class Miscreant::AES::SIV::Example
  ...
  CMAC_EXAMPLES = File.expand_path("../../vectors/aes_siv.tjson", __dir__)

  # AES-PMAC-SIV examples
  PMAC_EXAMPLES = File.expand_path("../../vectors/aes_pmac_siv.tjson", __dir__)
...
class Miscreant::AEAD::Example
  ...
  # Default file to load examples from
  DEFAULT_EXAMPLES = File.expand_path("../../vectors/aes_siv_aead.tjson", __dir__)
...
class Miscreant::STREAM::Example
  ...
  # Default file to load examples from
  DEFAULT_EXAMPLES = File.expand_path("../../vectors/aes_siv_stream.tjson", __dir__)
...
class DblExample
  ...
  # Default file to load examples from
  DEFAULT_EXAMPLES = File.expand_path("../../vectors/dbl.tjson", __dir__)
